 ...
 */
mp.Player.prototype.setWeaponTint = function (weaponHash: number, tintIndex: number) {
 ...
 */
mp.Player.prototype.getWeaponTint = function (weaponHash: number) {
...
mp.events.add('playerJoin', (player: PlayerMp) => {
	...
	console.log('Player weapon tints' + player.__weaponTints);
	/*
	player.giveWeapon(RageEnums.Hashes.Weapon.ADVANCEDRIFLE, 10000);
	player.giveWeaponComponent(RageEnums.Hashes.Weapon.ADVANCEDRIFLE, RageEnums.Weapons.Components.Advanced_Rifle.COMPONENT_AT_AR_SUPP);
	player.giveWeaponComponent(RageEnums.Hashes.Weapon.ADVANCEDRIFLE, RageEnums.Weapons.Components.Advanced_Rifle.COMPONENT_AT_SCOPE_SMALL);
	player.setWeaponTint(RageEnums.Hashes.Weapon.ADVANCEDRIFLE, 3);
	*/
});

mp.events.add('playerWeaponChange', (player: PlayerMp, _oldWeapon, newWeapon) => {
